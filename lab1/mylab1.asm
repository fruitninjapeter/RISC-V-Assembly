...
# Name: Peter Vu
.data
Name: .string "Peter Vu" # Your name in double quotes
...
CarryNoOV1:	.word	00000100  # Replace DDD with a decimal value.
CarryNoOV2:	.word	11111111  # Replace DDD with a decimal value.
...
SignNoCarry1:	.word	01001011  # Replace DDD with a decimal value.
SignNoCarry2:	.word	01010100  # Replace DDD with a decimal value.
